 ...
 */
final class Version20191227051709 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game_bet (id INT AUTO_INCREMENT NOT NULL, date_created DATETIME NOT NULL, amount DOUBLE PRECISION NOT NULL, pick INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE game_bet');
