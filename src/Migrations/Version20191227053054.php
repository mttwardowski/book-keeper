 ...
 */
final class Version20191227053054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game_bet ADD pick_value VARCHAR(255) DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game_bet DROP pick_value, CHANGE user_id user_id INT DEFAULT NULL');
