 ...
 */
final class Version20191231014653 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sport ADD default_bgurl VARCHAR(512) NOT NULL, CHANGE date_created date_created DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sport DROP default_bgurl, CHANGE date_created date_created DATETIME DEFAULT \'NULL\'');
